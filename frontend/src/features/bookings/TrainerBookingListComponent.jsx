...
export default function TrainerBookingListComponent() {
    ...
    useEffect(() => {
        if (user && user.id) {
            ...
            Bookings.getTrainerBookingsList(user.authenticationKey)
                .then(allBookings => {
                ...
                <div key={eachBooking.booking_id} className="my-2 card w-full p-5 bg-base-100 shadow-xl md:w-96 m-auto">
                    ...
                    <form>
                        <div>
                            ...
                            <p className="flex justify-center"><strong className="px-2">User: </strong> {eachBooking.user_id}</p>
                            <button
